        ...
        <div className="bg-black text-white py-20" id="about">
            <div className="container mx-auto px-8 md:px-16 lg:px-24"> 
                ...
                <div className="flex flex-col md:flex-row items-center md:space-x-12">
                    <img src={image} alt="" className="w-72 h-80 rounded object-cover mb-8 md:mb-0"/>
                    <div className="flex-1">
                        <p className="text-lg mb-8">
                            I am a passionate data scientist and full-stack developper with a focus on building modern and responsive web applications and predicting datasets. With a strong fondation in both mathematics, algorithms, frontend and backend technologies, I strive to create smeamless and efficient user experiences.
                        </p>
